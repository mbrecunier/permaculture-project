...
2	Phillips Head Screwdriver	img/Phillips-head-screwdriver.jpg	10
5	Hand Cultivator	img/hand-cultivator.jpg	5
1	Hammer	img/hammer.jpg	9
6	Hand Edger	img/hand-edger.jpg	5
7	Garden Hoe	img/hoe.jpg	5
8	Rake	img/rake.jpg	5
9	Scuffle Hoe	img/scuffle-hoe.jpg	5
10	Tow Behind Aerator	img/tow-behind-aerator.jpg	5
4	Budding Knife	img/budding-knife.jpg	5
\.
...
SELECT pg_catalog.setval('tools_id_seq', 10, true);
...
SELECT pg_catalog.setval('users_plants_id_seq', 4, true);
...
SELECT pg_catalog.setval('users_tools_id_seq', 11, true);
